...
//        speedFactor = 0.25f;
        ...
        sleep(1000); scoreboard.update(new LineupEvent(text, 0));
        ...
        sleep(1000); scoreboard.update(new ResultEvent(text, 0, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 1, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 2, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 3, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 4, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 5, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 6, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 7, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 8, events));
        sleep(1000); scoreboard.update(new ResultEvent(text, 9, events));
...
//        speedFactor = 0.25f;
            ...
            scoreboard.update(new TimeOfDayEvent(0));
            sleep(1000);
            scoreboard.update(new TimeOfDayEvent(1));
            ...
            System.out.println(new LineupEvent(text, 0));
            sleep(1000);
            scoreboard.update(new LineupEvent(text, 0));
            ...
            System.out.println(new RaceSplitTimeEvent(text, 0, 4));
            sleep(80);
            scoreboard.update(new RaceSplitTimeEvent(text, 0, 4));

            sleep(70);
            scoreboard.update(new RaceTimerEvent("50.35"));

            text.setText(3, "2  May Mackinder    WYCS    51.28 2  ");
            sleep(80);
            scoreboard.update(new RaceSplitTimeEvent(text, 0, 3));

            sleep(70);
            scoreboard.update(new RaceTimerEvent("51.32"));
            sleep(70);
            scoreboard.update(new RaceTimerEvent("53.05"));

            text.setText(5, "4  Shoshona Street  WYCS    53.17 3  ");
            sleep(80);
            scoreboard.update(new RaceSplitTimeEvent(text, 0, 5));

            sleep(1860);
            scoreboard.update(new RaceEvent(text, 0));
